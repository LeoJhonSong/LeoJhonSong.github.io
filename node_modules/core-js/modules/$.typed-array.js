...
if(require('./$.descriptors')){
  ...
  var proto = {
    ...
    map: function map(mapfn /*, thisArg */){
      return fromList(this, arrayMap(validate(this), mapfn, arguments.length > 1 ? arguments[1] : undefined)); // TDO
    },
    ...
    slice: function slice(start, end){
      return fromList(this, arraySlice.call(validate(this), start, end)); // TDO
    },
