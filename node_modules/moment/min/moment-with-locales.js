;(function (global, factory) {
    ...
    function set (config) {
        ...
        // TDO: Remove "ordinalParse" fallback in next major release.
    ...
    function loadLocale(name) {
        var oldLocale = null;
        // TDO: Find a better way to register and load all the locales in Node
    ...
    function dayOfYearFromWeekInfo(config) {
        ...
        if (w.GG != null || w.W != null || w.E != null) {
            ...
            // TDO: We need to take the current isoWeekYear, but that depends on
    ...
    function checkWeekday(weekdayStr, parsedInput, config) {
        if (weekdayStr) {
            // TDO: Replace the vanilla JS Date object with an indepentent day-of-week check.
    ...
    function configFromStringAndFormat(config) {
        // TDO: Move this to another part of the creation flow to prevent circular deps
    ...
    // TDO: remove 'name' arg after deprecation is removed
    ...
    hooks.defineLocale('fr', {
        ...
        ordinal : function (number, period) {
            switch (period) {
                // TDO: Return 'e' when day of month > 1. Move this case inside
